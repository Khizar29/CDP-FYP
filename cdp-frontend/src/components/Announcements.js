...
// // Sample announcements data with faculty names
// const announcementsData = [
//   {
//     title: "New Faculty Orientation",
//     description: "Join us for the new faculty orientation and learn about our teaching tools.",
//     date: "March 10, 2025",
//     type: "Onsite",
//     faculty: "Dr. John Smith",
//   },
//   {
//     title: "Semester Exam Dates Released",
//     description: "Check the updated exam dates for the upcoming semester.",
//     date: "March 15, 2025",
//     type: "Online",
...
//     description: "Attend a workshop discussing the impact of AI in modern education.",
//     date: "April 1, 2025",
//     type: "Hybrid",
//     faculty: "Dr. John Smith",
//   },
...
//     description: "Registration for the summer semester is now open. Don't miss out!",
//     date: "April 5, 2025",
//     type: "Online",
//     faculty: "Dr. Sarah Lee",
//   },
...
//     description: "Attend a research seminar on advancements in faculty-led research.",
//     date: "April 12, 2025",
//     type: "Onsite",
...
//   "Dr. Sarah Lee",
//   "Dr. Emily Davis",
//   "Dr. Michael Brown", // Add more faculty as needed
// ];
...
//     if (facultyName === "") {
//       setFilteredAnnouncements(announcementsData); // Show all announcements if no faculty is selected
//     } else {
//       const filtered = announcementsData.filter(
//         (announcement) => announcement.faculty === facultyName
//       );
//       setFilteredAnnouncements(filtered); // Filter announcements by faculty
//     }
//   };
...
//           {/* Smaller Faculty Filter Dropdown */}
...
//                 <h3 className="text-2xl font-semibold text-darkblue">{announcement.title}</h3>
...
//                 Posted by: <span className="font-medium text-darkblue">{announcement.faculty}</span>
//               </div>
...
//         params: {
//           searchTerm: facultyName ? facultyName : "",
//           page: 1,
//           limit: 10, // Set page size as needed
//         },
//       });
...
//               {/* Card Header */}
//               <div className="flex justify-between mb-4">
//                 <h3 className="text-2xl font-semibold text-darkblue">{announcement.heading}</h3>
//                 <span className="text-yellow-500 font-bold">{announcement.type}</span>
//               </div>

//               {/* Card Content */}
//               <p className="text-gray-600 mb-4">{announcement.text}</p>
//               <div className="flex justify-between text-gray-500 text-sm mb-1">
//                 <span>{formatDate(announcement.postedOn)}</span> {/* Format posted date */}
//               </div>

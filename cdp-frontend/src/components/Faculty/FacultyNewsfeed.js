...
const FacultyNewsfeed = () => {
  ...
  return (
    <div className="p-4 mx-auto">
      ...
      <button onClick={() => navigate('/faculty/newsfeed/add')} className="bg-blue-500 text-white py-2 px-4 rounded mb-4">Add News/Event</button>
          ...
          {newsItems.map((item, index) => (
            <tr key={item._id}>
              ...
              <td className="px-4 py-2 border flex gap-2">
                <button onClick={() => navigate(`/faculty/newsfeed/view/${item._id}`)} className="bg-blue-500 text-white px-2 py-1 rounded">View</button>
                <button onClick={() => navigate(`/faculty/newsfeed/edit/${item._id}`)} className="bg-yellow-500 text-white px-2 py-1 rounded">Edit</button>
...
export default FacultyNewsfeed;

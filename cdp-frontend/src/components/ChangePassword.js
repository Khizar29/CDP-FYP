...
import { FiLock, FiEye, FiEyeOff } from 'react-icons/fi'; // Importing icons
...
function ChangePassword() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-grow justify-center items-center bg-gradient-to-r from-blue-50 to-blue-100">

...
//   return (
//     <div ref={ref} id="about" className="bg-white pt-4 pb-2 md:pt-6 md:pb-4 overflow-hidden">
//       <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
//         {/* Slider Container */}
//         <div className="relative w-full min-h-screen overflow-hidden rounded-lg shadow-lg">
//           <div
...
//             <div className="w-full md:w-1/2 min-h-screen px-4 flex items-center justify-center">
...
//                       img: 'https://via.placeholder.com/150',
//                       link: 'https://www.linkedin.com/in/syed-muhammad-ali-b942502aa/'
//                     }
//                   ].map((dev, idx) => (
//                     <a
//                       key={idx}
